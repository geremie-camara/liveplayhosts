    ...
    <AuthenticatedLayout>
      <div className="max-w-7xl mx-auto">
        ...
        <nav className="mb-4 sm:mb-6">
          <ol className="flex items-center gap-1 sm:gap-2 text-xs sm:text-sm text-gray-500 flex-wrap">
            <li>
            ...
            <li>
              <Link href={`/training/courses/${course.id}`} className="hover:text-accent truncate max-w-[100px] sm:max-w-none inline-block align-middle">
                {course.title}
              </Link>
            </li>
            <li>
            ...
            <li className="text-dark font-medium truncate max-w-[120px] sm:max-w-none">{lesson.title}</li>
          </ol>
        </nav>
          ...
          <div className="lg:col-span-2">
            ...
            <div className="bg-white rounded-2xl shadow-sm p-4 sm:p-6 mb-4 sm:mb-6">
              <div className="flex flex-wrap items-center gap-2 sm:gap-3 mb-3 sm:mb-4">
                <span className="px-2 sm:px-3 py-1 rounded-full text-xs sm:text-sm font-medium bg-gray-100 text-gray-700">
              ...
              <h1 className="text-xl sm:text-2xl font-bold text-dark">{lesson.title}</h1>
            </div>
            ...
            <div className="flex flex-col sm:flex-row items-stretch sm:items-center justify-between gap-3 sm:gap-4">
              {prevLesson ? (
                <Link
                  ...
                  className="flex items-center gap-2 px-3 sm:px-4 py-2 text-gray-600 hover:text-accent transition-colors text-sm sm:text-base"
                >
                  ...
                  <span className="font-medium truncate max-w-[120px] sm:max-w-[150px]">{prevLesson.title}</span>
                </Link>
              ) : (
              ...
              {nextLesson && !nextLessonLocked ? (
                <Link
                  ...
                  className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-accent text-white rounded-lg hover:bg-accent/90 transition-colors text-sm sm:text-base"
                >
                  <span className="hidden sm:inline">Next:</span>
                  <span className="font-medium truncate max-w-[120px] sm:max-w-[150px]">{nextLesson.title}</span>
                  <svg className="w-4 h-4 sm:w-5 sm:h-5 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path
                      strokeLinecap="round"
                      strokeLinejoin="round"
                ...
                <div className="flex items-center justify-center gap-2 px-3 sm:px-4 py-2 bg-gray-100 text-gray-400 rounded-lg cursor-not-allowed text-xs sm:text-sm">
            ...
            <div className="lg:sticky lg:top-6">
              <div className="bg-white rounded-2xl shadow-sm p-4">
                <div className="flex items-center justify-between mb-3 sm:mb-4">
                  <h3 className="font-semibold text-dark text-sm sm:text-base">Course Content</h3>
                  <Link
                    href={`/training/courses/${course.id}`}
