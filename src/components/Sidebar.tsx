...
export default function Sidebar({ userRole, userName }: SidebarProps) {
  ...
  const adminItems: NavItem[] = [
    ...
    {
      label: "Host Priority",
      href: "/admin/host-priority",
      permission: "manageHostPriority",
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    ...
    {
      label: "Avail. Changelog",
      href: "/admin/availability-changelog",
      permission: "manageAvailability",
      icon: (
        <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  // Security is owner-only — separate from permission-filtered admin items
  const securityItem: NavItem | null = userRole === "owner" ? {
    label: "Security",
    href: "/admin/security",
    icon: (
      <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
  ...
  return (
    <>
      ...
      {/* Sidebar */}
      <aside
        className={`fixed top-0 left-0 h-full w-64 bg-white border-r z-50 transform transition-transform duration-200 ease-in-out ${
      ...
      >
        <div className="flex flex-col h-full">
          ...
          <nav className="flex-1 overflow-y-auto p-4 space-y-1">
            ...
            {(filteredAdminItems.length > 0 || securityItem) && (
              <>
                ...
                {securityItem && <NavLink item={securityItem} />}
              </>
            )}
          </nav>
